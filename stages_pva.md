...
![](stages_pva_files/figure-gfm/lotus_arinagensis1.jpg) La imagen es una captura de pantalla de la información recogida en el Atlas y Libro Rojo de la Flora Vascular Amenazada de España, [disponible en pdf; Ctrl click para abrir en otra pestaña](https://www.miteco.gob.es/es/biodiversidad/temas/inventarios-nacionales/829_tcm30-99330.pdf).
...
Definimos además dos vectores alternativos de abundancias en t = 0, *N<sub>0</sub>*; uno con el mismo número de individuos por estadio, y otro con mayoría del estadio *repro3*:
...
![](stages_pva_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
El resultado de la *proyección estocástica* lo almacenamos en un objeto **lotus\_stoch\_proj**. Los argumentos de la función son el tiempo de proyección `tmax=` y el número de repeticiones `nreps=`:
...
-   *Simulada*, utilizando en cada repetición una de las 3 matrices disponibles en **lotus\_lista**.
...
```
    ...
    ## [1,] 0.3156328 0.000000000 0.0002247668 0.1177508
    ## [2,] 0.5588821 0.002812287 0.0034605696 0.2347422
    ## [3,] 1.0021309 0.004345660 0.0055513789 0.4259559
    ## [4,] 1.8012237 0.007105521 0.0093625151 0.7791281
    ## 
    ## $elasticities
    ##       plántula       repro1       repro2      repro3
    ## [1,] 0.0000000 0.0000000000 1.174603e-04 0.253422463
    ## [2,] 0.0000000 0.0000000000 0.000000e+00 0.000000000
    ## [3,] 0.0000000 0.0001390611 8.715346e-05 0.000909949
    ## [4,] 0.2475912 0.0018332245 3.942673e-03 0.491956833
...
```
    ...
    ## [20,] 0.069 0.065 0.074 0.065 0.079 0.058 0.048 0.067 0.077 0.073
    ## [21,] 0.079 0.076 0.079 0.074 0.087 0.068 0.059 0.076 0.084 0.086
    ## [22,] 0.086 0.084 0.089 0.088 0.094 0.079 0.063 0.087 0.087 0.094
    ## [23,] 0.098 0.094 0.100 0.094 0.100 0.089 0.076 0.093 0.094 0.105
    ## [24,] 0.110 0.103 0.108 0.097 0.107 0.098 0.084 0.104 0.100 0.117
    ## [25,] 0.119 0.113 0.116 0.105 0.111 0.105 0.092 0.116 0.108 0.126
...
![](stages_pva_files/figure-markdown_github/unnamed-chunk-16-1.png)
