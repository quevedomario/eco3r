...
Los procedimientos incluidos a continuación asumen la instalación previa de R^2^ y RStudio^3^, para trabajar en este último. Instrucciones al respecto se encuentran en el apartado *Configuración* del módulo **Ecología en código abierto** del Campus Virtual de UniOvi.
