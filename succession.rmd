...
El código se lee "*para cada intervalo de tiempo i entre 1 a 6, almacena como n0 el resultado de multiplicar la matriz por el N~0~ previo, guarda el resultado en la columna i de proyecciones, y muestra la matriz*"^3^. En la consola **R** aparecerá brevemente el estado de la matriz en cada intervalo.
