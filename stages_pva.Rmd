...
Una vez definido el modelo de la población, podemos empezar a extraerle información. Por ejemplo, dibujando el ciclo de vida de *L. arinagensis* con la función `plotmat()`. Puede parecer complicada, ya ofrece muchas posibilidades de ajustar el aspecto final del gráfico (e.g. muchos *argumentos*): 
```{r, fig.asp=0.8}
